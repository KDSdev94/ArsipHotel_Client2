                    ...
                    <div className="relative z-20 flex flex-col justify-between h-full p-16 text-white">
                        <div className="flex items-center gap-3">
                            <div className="bg-white/10 backdrop-blur-md p-2 rounded-lg border border-white/20">
                                <svg className="size-8 text-white" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="w-full max-w-[420px] flex flex-col">
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleLogin}>
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="flex justify-between items-center">
                                    ...
                                    <a className="text-primary hover:text-primary/80 text-sm font-semibold leading-normal underline transition-colors" href="#">
                                        Lupa Kata Sandi?
                                    </a>
                                </div>
                                <div className="relative group">
                        ...
                        <footer className="mt-12 pt-8 border-t border-[#f0f2f4] dark:border-gray-800 text-center">
                            <p className="text-[#616f89] dark:text-gray-400 text-sm">
                                Belum punya akun?
                                <a className="text-primary font-bold hover:underline ml-1" href="#">Daftar sekarang</a>
                            </p>
                            <div className="mt-8 flex justify-center gap-6">
                                <button className="flex items-center gap-1.5 text-xs text-[#616f89] dark:text-gray-500 hover:text-primary transition-colors">
