        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-900">
          ...
          <div className="relative z-20 flex flex-col justify-between h-full p-16 text-white">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold tracking-tight">Arsip Hotel</h2>
            </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-background-dark">
          <div className="w-full max-w-105 flex flex-col">
            ...
            <div className="lg:hidden flex items-center gap-3 mb-12">
              ...
              <h2 className="text-2xl font-bold dark:text-white">Arsip Hotel</h2>
            </div>
            ...
            <form className="flex flex-col gap-5" onSubmit={handleLogin}>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    className="text-primary hover:text-primary/80 text-sm font-semibold leading-normal underline transition-colors"
                    to="/forgot-password"
                  >
                    Lupa Kata Sandi?
                  </Link>
