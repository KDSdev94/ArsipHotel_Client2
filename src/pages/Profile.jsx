...
const Profile = () => {
    ...
    return (
        <Layout title="Profil Pengguna" showBack={true}>
            <div className="max-w-4xl mx-auto w-full">
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div className="h-32 md:h-48 bg-linear-to-r from-primary to-blue-400 relative">
                        <div className="absolute -bottom-12 md:-bottom-16 left-6 md:left-8 p-1 bg-white dark:bg-gray-800 rounded-full shadow-lg">
                            <div className="size-24 md:size-32 rounded-full bg-blue-50 flex items-center justify-center text-primary border-4 border-white dark:border-gray-800 overflow-hidden">
                                {userProfile?.photoURL ? (
                                    <img src={userProfile.photoURL} alt="Profile" className="w-full h-full object-cover" />
                                ) : (
                                    <span className="material-symbols-outlined text-4xl md:text-6xl">account_circle</span>
                                )}
                            </div>
                        </div>
                    </div>

                    <div className="pt-16 md:pt-20 px-6 md:px-8 pb-8">
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8">
                            ...
                            <button className="w-full sm:w-auto px-6 py-2 border-2 border-primary text-primary hover:bg-primary hover:text-white rounded-xl font-bold transition-all text-sm">
                                Edit Profil
                            </button>
                        </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-bold text-slate-700 dark:text-slate-200 truncate max-w-[150px] sm:max-w-none">{currentUser?.email}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
