...
const TabelDokumen = () => {
    // Data dummy (palsu) buat contoh tampilan tabel. 
    // Nanti kalau sudah ada databasenya, data ini bakal diambil dari API/Firebase.
    const documents = [
        {
            id: 1,
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        {documents.map((doc) => (
                            <tr key={doc.id} className="hover:bg-gray-50/80 dark:hover:bg-gray-700/30 transition-colors group">
                                ...
                                <td className="px-6 py-5">
                                    {/* Label Kategori dengan background warna-warni biar cantik */}
                                ...
                                <td className="px-6 py-5 text-right">
                                    {/* Tombol aksi (Lihat, Download, Hapus) yang cuma muncul jelas pas row di-hover */}
            ...
            <div className="px-6 py-4 flex items-center justify-between border-t border-gray-100 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-900/20">
                ...
                <div className="flex gap-2">
                    ...
                    {/* Halaman aktif warnanya biru (primary) */}
